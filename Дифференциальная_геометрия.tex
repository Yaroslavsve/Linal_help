...
\begin{document}
    ...
    \begin{proof}
        ...
        Рассмотрим $-(n', \ b)=k\cdot(v, \ b)+\kappa\cdot(b, \ b)=\kappa$, значит, $\kappa(s)$ --- гладкая функция.
    \end{proof}
    \begin{definition}
    ...
    \end{exercise}
    \begin{proof}
        Рассмотрим вектор $\omega=-\kappa\cdot v-k\cdot b$ и проверим, что он удовлетворяет нужным условиям.
        \begin{enumerate}
            \item $[\omega, \ v]=[(-\kappa\cdot v-k\cdot b), \ v]=-\kappa[v, \ v]-k[b, \ v]=-k[[v, \ n], \ v]$ (из определения вектора $b$), тогда $[\omega, \ v]=-k(v\cdot(n, \ v)-n\cdot(v, \ v))=k\cdot n=v'$.
            \item $[\omega, \ n]=[(-\kappa\cdot v-k\cdot b), \ n]=-\kappa[v, \ n]-k[b, \ n]=-\kappa\cdot b-k[[v, \ n], \ n]$ (из определения вектора $b$), тогда $[\omega, \ n]=-\kappa\cdot b-k(v\cdot(n, \ n)-n\cdot(v, \ n))=-\kappa\cdot b-k\cdot v=n'$.
            \item $[\omega, \ b]=[(-\kappa\cdot v-k\cdot b), \ v]=-\kappa[v, \ b]-k[b, \ b]=-\kappa[v, [v, \ n]]$ (из определения вектора $b$), тогда $[\omega, \ b]=-\kappa(v\cdot(v, \ n)-n\cdot(v, \ v))=\kappa\cdot n=b'$.
        \end{enumerate}
    \end{proof}
    \begin{definition}
